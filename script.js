import { factOpinionScenarios, rewards, badges, levels, TIME_LIMIT, STREAK_REQUIREMENT } from './config.js';
...
let scenarios = factOpinionScenarios;
...
function restartGame() {
    ...
    const restartBtn = document.querySelector('.game-container button:not(#next-btn):not(#fact-btn):not(#opinion-btn)');
    if (restartBtn) {
        restartBtn.remove();
    }
